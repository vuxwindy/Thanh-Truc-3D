...
export const ChatProvider = ({ children }) => {
  ...
  const startNewConversation = async () => {
    ...
    try {
      ...
      setMessages([
        { id: 1, text: 'Xin chào! Tôi là trợ lý AI của Lucentis. Tôi có thể giúp gì cho bạn?', sender: 'bot' }
      ]);
  ...
  const endConversation = async () => {
    ...
    try {
      ...
      setMessages([
        { id: Date.now(), text: 'Xin chào! Tôi là trợ lý AI của Lucentis. Tôi có thể giúp gì cho bạn?', sender: 'bot' }
      ]);
    } catch (error) {
